...
<!--                        <div class="my-2">-->
<!--                            <Button :label="$t('crud_table.btn_remove')" icon="pi pi-trash" class="p-button-danger"-->
...
<!--                    <template v-slot:end>-->
<!--                        <Button :label="$t('crud_table.export_to_csv')" icon="pi pi-upload" class="p-button-help"-->
